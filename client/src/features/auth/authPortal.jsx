    ...
    <div className="registerContextDiv">
        <div className="text">
            ...
            <p className="bigDescription">
                You know the feeling. You open your editor after a few days away and have no idea what you were doing, why that function is half written, or what that commit from two days ago was even supposed to do. Bugs pile up in random text files, notes live in three different apps, and your Git history makes no sense. <br />  <br />Handled helps developers be more organized by providing a smart notes system with intuitive features.
                <br />
